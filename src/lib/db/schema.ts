...
export const transactions = pgTable(
  "transactions",
  {
    ...
    // Extra detail surfaced in the transaction detail sheet. All nullable —
    // populated opportunistically from Plaid; older rows backfill on next sync.
    ...
    locationLat: numeric("location_lat", { precision: 9, scale: 6, mode: "number" }),
    locationLon: numeric("location_lon", { precision: 9, scale: 6, mode: "number" }),
